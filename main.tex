...
\begin{titlepage}
	...
	\begin{minipage}[t]{\textwidth}
		\begin{minipage}[t]{0.5\textwidth}
			Johannes Stölzle, \hspace{0.15cm}Luan Bajramaj\\
			Birnbaumstrasse 6, \hspace{0.15cm}Bilchenstrasse 10\\
			9320 Arbon, \hspace{0.15cm}8580 Amriswil\\
			079 349 57 76, \hspace{0.15cm}076 390 82 67\\
			jostoelz@ksr.ch, \hspace{0.15cm}lubajram@ksr.ch
		\end{minipage}
		\begin{minipage}[t]{0.5\textwidth}
			\begin{flushright}
	...
	{
		\centering
		\Huge\bfseries Bau einer eigenen Batterie\par
		\vspace{1cm}
	...
	\noindent
	Fach: Chemie \noindent\\
	Betreuungsperson: Stefan Bosshart\\
	Abgabetermin: 30. März 2025
...
\newpage
\section{Einstiegsexperiment}
\subsection{Material und Methoden}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Zuerst haben wir bei einer Cola-Dose aus Aluminium den Deckel mit einer Schere entfernt und danach mit Schmirgelpapier das Innere aufgeraut. Anschliessend haben wir eine Krokodilklemme an den oberen Rand der Dose befestigt und das andere Ende der Krokodilklemme (während dem Messen der Stromstärke) in das Multimeter (COM-Anschluss) gesteckt. Bild \ref{fig Aufbau_Einstiegsexperiment.} verdeutlicht den Aufbau des Experiments.
\begin{figure}[H]
	\centering
	\includegraphics[width=0.4\textwidth]{Aufbau_Einstiegsexperiment.JPEG}
	\caption[Eintrag in Abbildungsverzeichnis von Grumpy Cat]{Aufbau des Einstiegsexperiments}
	\label{fig Aufbau_Einstiegsexperiment.}
\end{figure}
\newpage
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.4\textwidth]{gross_klein_Grillkohle.JPEG}
	\caption[Eintrag in Abbildungsverzeichnis von Grumpy Cat]{unterschiedliche Grösse Grillkohle}
	\label{fig gross_klein_Grillkohle.}
\end{figure}
\begin{figure}[H]
	\centering
	\includegraphics[width=0.4\textwidth]{Stab_tief_Wasser.JPEG}
	\caption[Eintrag in Abbildungsverzeichnis von Grumpy Cat]{Stab tief im Wasser}
	\label{fig Stab_tief_Wasser.}
\end{figure}
\begin{figure}[H]
	\centering
	\includegraphics[width=0.4\textwidth]{Stab_wenig_Wasser.JPEG}
	\caption[Eintrag in Abbildungsverzeichnis von Grumpy Cat]{Stab wenig im Wasser}
	\label{fig Stab_wenig_Wasser.}
\end{figure}
\newpage
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.4\textwidth]{Aufbau_eine_Zelle.JPEG}
	\caption[Eintrag in Abbildungsverzeichnis von Grumpy Cat]{Aufbau einer Zelle}
	\label{fig Aufbau_Einstiegsexperiment.}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.4\textwidth]{Abbau_Aluminium.JPEG}
	\caption[Eintrag in Abbildungsverzeichnis von Grumpy Cat]{Auflösung der Aluminium-Platte}
	\label{fig Abbau_Alluminium.}
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
